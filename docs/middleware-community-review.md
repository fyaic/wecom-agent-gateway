...
2026-09-07 状态校正：下方第 3 项中的 macOS/Linux 无缓存安装门已完成；维护者新目录真实 Pi 注册、
多轮与重启也已[实测通过](reviews/fresh-real-onboarding-2026-09-07.md)。后续关注陌生用户反馈和实际运行
认证，不再次把工具开发当作尚未完成的真实验证。外部协议 ADR 仅在具体接入障碍出现后推进，不独立扩范围。
